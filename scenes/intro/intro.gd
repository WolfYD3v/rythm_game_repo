...
const CONTENT_WARNING_SCENE_PATH: String = "res://scenes/content_warning/content_warning.tscn"
...
func _ready() -> void:
	...
	SceneManager.add_scene("ContentWarning", CONTENT_WARNING_SCENE_PATH)
